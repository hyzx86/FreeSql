...
namespace FreeSql.Internal.CommonProvider
{
    partial class AdoProvider
    {
        ...
        static ConcurrentDictionary<int, Regex> _dicAddslashesReplaceIsNull = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicAddslashesReplaceIsNull", new ConcurrentDictionary<int, Regex>());
