...
namespace FreeSql.Internal
{
    ...
    public abstract class CommonExpression
    {
        ...
        static ConcurrentDictionary<string, Regex> dicRegexAlias = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "dicRegexAlias", new ConcurrentDictionary<string, Regex>());
        ...
        static ConcurrentDictionary<Type, MethodInfo> _dicExpressionLambdaToSqlAsSelectMethodInfo = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicExpressionLambdaToSqlAsSelectMethodInfo", new ConcurrentDictionary<Type, MethodInfo>());
        static ConcurrentDictionary<Type, MethodInfo> _dicExpressionLambdaToSqlAsSelectWhereMethodInfo = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicExpressionLambdaToSqlAsSelectWhereMethodInfo", new ConcurrentDictionary<Type, MethodInfo>());
        static ConcurrentDictionary<Type, MethodInfo> _dicExpressionLambdaToSqlAsSelectWhereSqlMethodInfo = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicExpressionLambdaToSqlAsSelectWhereSqlMethodInfo", new ConcurrentDictionary<Type, MethodInfo>());
        static ConcurrentDictionary<Type, ConcurrentDictionary<string, MethodInfo>> _dicExpressionLambdaToSqlAsSelectAggMethodInfo = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicExpressionLambdaToSqlAsSelectAggMethodInfo", new ConcurrentDictionary<Type, ConcurrentDictionary<string, MethodInfo>>());
        internal static ConcurrentDictionary<Type, PropertyInfo> _dicNullableValueProperty = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicNullableValueProperty", new ConcurrentDictionary<Type, PropertyInfo>());
        static ConcurrentDictionary<Type, Expression> _dicFreeSqlGlobalExtensionsAsSelectExpression = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicFreeSqlGlobalExtensionsAsSelectExpression", new ConcurrentDictionary<Type, Expression>());
        ...
        static ConcurrentDictionary<Type, bool> _dicTypeExistsExpressionCallAttribute = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + nameof(_dicTypeExistsExpressionCallAttribute), new ConcurrentDictionary<Type, bool>());
        static ConcurrentDictionary<Type, ConcurrentDictionary<string, bool>> _dicMethodExistsExpressionCallAttribute = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + nameof(_dicMethodExistsExpressionCallAttribute), new ConcurrentDictionary<Type, ConcurrentDictionary<string, bool>>());
        static ConcurrentDictionary<Type, FieldInfo[]> _dicTypeExpressionCallClassContextFields = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + nameof(_dicTypeExpressionCallClassContextFields), new ConcurrentDictionary<Type, FieldInfo[]>());
        static ThreadLocal<List<BaseDiyMemberExpression>> _subSelectParentDiyMemExps = Utils.GlobalCacheFactory.CreateCacheItem<ThreadLocal<List<BaseDiyMemberExpression>>>(CacheKey + nameof(_subSelectParentDiyMemExps)); //子查询的所有父自定义查询，比如分组之后的子查询
        static ConcurrentDictionary<Type, MethodInfo> _dicSelectMethodToSql = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + nameof(_dicSelectMethodToSql), new ConcurrentDictionary<Type, MethodInfo>());
        ...
        static ConcurrentDictionary<Type, ConcurrentDictionary<string, bool>> _dicGetWhereCascadeSqlError = Utils.GlobalCacheFactory.CreateCacheItem<ConcurrentDictionary<Type, ConcurrentDictionary<string, bool>>>("_dicGetWhereCascadeSqlError");
