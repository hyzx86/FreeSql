...
namespace FreeSql.Extensions.EntityUtil
{
    public static class EntityUtilExtensions
    {
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, bool, string>>> _dicGetEntityKeyString
            = Utils.GlobalCacheFactory.CreateCacheItem<ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, bool, string>>>>(CacheKey + "_dicGetEntityKeyString");
        /// <summary>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, object[]>>> _dicGetEntityKeyValues = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicGetEntityKeyValues", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, object[]>>>());
        /// <summary>
        /// 获取实体的主键值，多个主键返回数组
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, ConcurrentDictionary<string, Func<object, object>>>> _dicGetEntityValueWithPropertyName
            = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "_dicGetEntityValueWithPropertyName", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, ConcurrentDictionary<string, Func<object, object>>>>());
        /// <summary>
        /// 获取实体的属性值
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, string>>> _dicGetEntityString = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicGetEntityString", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, string>>>());
        /// <summary>
        ...
        /// 使用新实体的值，复盖旧实体的值
        /// </summary>
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, object>>> _dicMapEntityValue = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicMapEntityValue", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, object>>>());
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, object>>> _dicMapEntityKeyValue = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicMapEntityKeyValue", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, object>>>());
        /// <summary>
        /// 使用新实体的主键值，复盖旧实体的主键值
        /// </summary>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, long>>> _dicSetEntityIdentityValueWithPrimary = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicSetEntityIdentityValueWithPrimary", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, long>>>());
        /// <summary>
        /// 设置实体中主键内的自增字段值（若存在）
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, long>>> _dicGetEntityIdentityValueWithPrimary = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicGetEntityIdentityValueWithPrimary", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, long>>>());
        /// <summary>
        /// 获取实体中主键内的自增字段值（若存在）
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object>>> _dicClearEntityPrimaryValueWithIdentityAndGuid = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicClearEntityPrimaryValueWithIdentityAndGuid", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object>>>());
        /// <summary>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object>>> _dicClearEntityPrimaryValueWithIdentity = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicClearEntityPrimaryValueWithIdentity", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object>>>());
        /// <summary>
        /// 清除实体的主键值，将自增、Guid类型的主键值清除
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, object, bool, string[]>>> _dicCompareEntityValueReturnColumns = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicCompareEntityValueReturnColumns", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Func<object, object, bool, string[]>>>());
        /// <summary>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, string, int>>> _dicSetEntityIncrByWithPropertyName = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicSetEntityIncrByWithPropertyName", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, Action<object, string, int>>>());
        /// <summary>
        /// 设置实体中某属性的数值增加指定的值
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<DataType, ConcurrentDictionary<Type, ConcurrentDictionary<string, Action<object, string, object>>>> _dicSetEntityValueWithPropertyName = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicSetEntityValueWithPropertyName", new ConcurrentDictionary<DataType, ConcurrentDictionary<Type, ConcurrentDictionary<string, Action<object, string, object>>>>());
        /// <summary>
        /// 设置实体中某属性的值
        /// </summary>
        /// <param name="orm"></param>
        ...
        static ConcurrentDictionary<Type, MethodInfo[]> _dicAppendEntityUpdateSetWithColumnMethods = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicAppendEntityUpdateSetWithColumnMethods", new ConcurrentDictionary<Type, MethodInfo[]>());
        static ConcurrentDictionary<Type, ConcurrentDictionary<Type, MethodInfo>> _dicAppendEntityUpdateSetWithColumnMethod = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey + "__dicAppendEntityUpdateSetWithColumnMethod", new ConcurrentDictionary<Type, ConcurrentDictionary<Type, MethodInfo>>());
        /// <summary>
        /// 缓存执行 IUpdate.Set
        /// </summary>
