...
namespace FreeSql.Odbc.Oracle
{
    class OdbcOracleDbFirst : IDbFirst
    {
        ...
        static ConcurrentDictionary<string, DbToCs> _dicDbToCs = Utils.GlobalCacheFactory.CreateCacheItem("OdbcOracleDbFirst._dicDbToCs", new ConcurrentDictionary<string, DbToCs>(StringComparer.CurrentCultureIgnoreCase));
