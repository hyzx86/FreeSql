...
namespace FreeSql.Odbc.PostgreSQL
{
    ...
    class OdbcPostgreSQLConnectionPoolPolicy : IPolicy<DbConnection>
    {
        ...
        static ConcurrentDictionary<string, int> dicConnStrIncr =FreeSql.Internal. Utils.GlobalCacheFactory.CreateCacheItem("OdbcPostgreSQLConnectionPool.dicConnStrIncr", new ConcurrentDictionary<string, int>(StringComparer.CurrentCultureIgnoreCase));
