...
namespace FreeSql.Odbc.KingbaseES
{
    ...
    class OdbcKingbaseESConnectionPoolPolicy : IPolicy<DbConnection>
    {
        ...
        static ConcurrentDictionary<string, int> dicConnStrIncr = FreeSql.Internal.Utils.GlobalCacheFactory.CreateCacheItem("OdbcKingbaseESConnectionPoolPolicy.dicConnStrIncr", new ConcurrentDictionary<string, int>(StringComparer.CurrentCultureIgnoreCase));
