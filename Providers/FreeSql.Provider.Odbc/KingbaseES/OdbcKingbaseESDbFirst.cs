...
namespace FreeSql.Odbc.KingbaseES
{
    class OdbcKingbaseESDbFirst : IDbFirst
    {
        ...
        static ConcurrentDictionary<int, DbToCs> _dicDbToCs = Utils.GlobalCacheFactory.CreateCacheItem("OdbcKingbaseESDbFirst._dicDbToCs", new ConcurrentDictionary<int, DbToCs>());
