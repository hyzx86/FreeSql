...
namespace FreeSql.MySql
{
    ...
    class MySqlUtils : CommonUtils
    {
        ...
        static ConcurrentDictionary<Type, Dictionary<string, int>> _dicEnumNames = Utils.GlobalCacheFactory.CreateCacheItem(CacheKey+ "_dicEnumNames", new ConcurrentDictionary<Type, Dictionary<string, int>>());
