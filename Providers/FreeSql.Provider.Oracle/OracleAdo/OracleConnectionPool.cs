...
namespace FreeSql.Oracle
{
    ...
    class OracleConnectionPoolPolicy : IPolicy<DbConnection>
    {
        ...
        static ConcurrentDictionary<string, int> dicConnStrIncr =FreeSql.Internal. Utils.GlobalCacheFactory.CreateCacheItem("OracleConnectionPoolPolicy.dicConnStrIncr", new ConcurrentDictionary<string, int>(StringComparer.CurrentCultureIgnoreCase));
