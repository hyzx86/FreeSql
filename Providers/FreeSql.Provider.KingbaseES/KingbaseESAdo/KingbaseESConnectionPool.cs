...
namespace FreeSql.KingbaseES
{
    ...
    class KingbaseESConnectionPool : ObjectPool<DbConnection>
    {
        ...
        public KingbaseESConnectionPool(string name, string connectionString, Action availableHandler, Action unavailableHandler) : base(null)
        {
            this.UserId = KingbaseESConnectionPool.GetUserId(connectionString);

            this.availableHandler = availableHandler;
            this.unavailableHandler = unavailableHandler;
            var policy = new KingbaseESConnectionPoolPolicy
            {
                _pool = this,
                Name = name
            };
    ...
    class KingbaseESConnectionPoolPolicy : IPolicy<DbConnection>
    {
        ...
        {
            var conn = new KdbndpConnection(_connectionString);
            return conn;
        }
