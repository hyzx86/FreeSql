...
namespace FreeSql.PostgreSQL
{
    ...
    class PostgreSQLConnectionPoolPolicy : IPolicy<DbConnection>
    {
        ...
        static ConcurrentDictionary<string, int> dicConnStrIncr =FreeSql.Internal. Utils.GlobalCacheFactory.CreateCacheItem("PostgreSQLConnectionPoolPolicy.dicConnStrIncr", new ConcurrentDictionary<string, int>(StringComparer.CurrentCultureIgnoreCase));
