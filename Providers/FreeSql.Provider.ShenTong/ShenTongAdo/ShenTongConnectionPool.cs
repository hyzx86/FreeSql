...
namespace FreeSql.ShenTong
{
    ...
    class ShenTongConnectionPool : ObjectPool<DbConnection>
    {

        internal Action availableHandler;
        internal Action unavailableHandler;

        public ShenTongConnectionPool(string name, string connectionString, Action availableHandler, Action unavailableHandler) : base(null)
        {
            this.availableHandler = availableHandler;
            this.unavailableHandler = unavailableHandler;
            var policy = new ShenTongConnectionPoolPolicy
            {
                _pool = this,
                Name = name
            };
    ...
    class ShenTongConnectionPoolPolicy : IPolicy<DbConnection>
    {
        ...
        static ConcurrentDictionary<string, int> dicConnStrIncr = FreeSql.Internal.Utils.GlobalCacheFactory.CreateCacheItem("ShenTongConnectionPoolPolicy.dicConnStrIncr", new ConcurrentDictionary<string, int>(StringComparer.CurrentCultureIgnoreCase));
        ...
        public string ConnectionString
        {
            ...
            set
            {
                ...
                _connectionString = m.Success ?
                    Regex.Replace(_connectionString, pattern, $"MAXPOOLSIZE={PoolSize}", RegexOptions.IgnoreCase) :
                    $"{_connectionString};MAXPOOLSIZE={PoolSize}";
        ...
        {
            var conn = new OscarConnection(_connectionString);
            return conn;
        }
        ...
        public void OnDestroy(DbConnection obj)
        {
            ...
            try { (obj as OscarConnection)?.ClearPool(); } catch { }
            obj.Dispose();
        }
