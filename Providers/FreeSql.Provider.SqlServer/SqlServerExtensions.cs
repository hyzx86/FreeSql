...
public static partial class FreeSqlSqlServerGlobalExtensions
{
    ...
    internal static ConcurrentDictionary<Guid, NativeTuple<SqlServerLock, Dictionary<Type, bool>>> _dicSetGlobalSelectWithLock = 
        FreeSql.Internal.Utils.GlobalCacheFactory.CreateCacheItem("FreeSqlSqlServerGlobalExtensions._dicSetGlobalSelectWithLock", new ConcurrentDictionary<Guid, NativeTuple<SqlServerLock, Dictionary<Type, bool>>>());
